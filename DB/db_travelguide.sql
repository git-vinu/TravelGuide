...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 05, 2024 at 01:00 PM
...
(4, 'Ekru kappola', 'ekrukappola369@gmail.com', 'kappola@369', '9061152668', 'Kappola House Cembra', 'UserPhoto_1057.jpg', 11);
...
(2, 2, 8, '21:06', '2024-03-28', '1', 'Haii I Am VINU', '2024-03-27'),
(3, 2, 8, '21:39', '2024-03-29', '1', 'haii i am vinu', '2024-03-28'),
(4, 2, 8, '21:39', '2024-03-27', '0', 'haii i am vinu', '2024-03-28'),
(5, 2, 8, '21:39', '2024-03-29', '1', 'haii i am vinu', '2024-03-28');
...
(9, 'Ajeesh T Santohs', 'ajeesht333@gimail.com', '6282089434', 'vinu553', 'Meletathu House Munnar', '0', 'UserPhoto_1955.jpg', 8);
...
(15, '11:23', '2024-03-28', '1', 'Haii I Am VINU M', '2024-03-27', 7, 8),
(16, '11:23', '2024-03-28', '1', 'Haii I Am VINU M', '2024-03-27', 7, 8),
(17, '13:03', '2024-03-28', '1', 'Haii I Am Shinoy', '2024-03-27', 7, 8);
...
(17, 'Sijo Santhosh', 'sijosanthosh@gmail.com', 'sijo55', '7012892086', 'Valiyetathu House Tekkady', 'UserPhoto_1312.jpeg', 9);
...
(6, 15, 8, '21:19', '2024-03-28', '1', 'Haii I Am VINU', '2024-03-27');
...
(12, 'Hotel Vinayak', 'vinayaka@gmail.com', 'vinayaka@V', '9063829054', 'Vinayaka Hotals Munnar', 'UserPhoto_1631.avif', '0', 8);
...
(5, 10, 8, '2024-03-28', '21:31', '2024-03-27', '0', '1', 'Haii I Am SHYAM');
...
(8, 'Vinu M Varughese', 'vinumvarughese@555gmail.com', 'vinu553', '7025925555', 'parampil memuriyil thadiyoor po pathanamthitta', 'UserPhoto_2045.jpg', 5),
(9, 'Shyam Kumar ', 'shyam666@gmail.com', 'shyam123', '7025925542', 'Vettukattil(H) peruva', 'UserPhoto_1669.jpeg', 6),
(11, 'Hinata Hyuga', 'hinata@gmail.com', 'Hinata@55', '7063891249', 'Hyuga House Thiruvalla', 'UserPhoto_1423.webp', 4);
...
--
ALTER TABLE `tbl_advicor`
  MODIFY `advicor_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `tbl_advicorbooking`
--
ALTER TABLE `tbl_advicorbooking`
  MODIFY `advicorbooking_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `tbl_driver`
  MODIFY `driver_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `tbl_driverbooking`
--
ALTER TABLE `tbl_driverbooking`
  MODIFY `driverbooking_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `tbl_guidebooking`
  MODIFY `guidebooking_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `tbl_hotelbooking`
  MODIFY `hotelbooking_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
