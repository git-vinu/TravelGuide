        ...
        <div id="tab">
            <%
                if (request.getParameter("btnedit") != null) {
                    String selu = "select * from tbl_guide where guide_password='" + request.getParameter("txtcurnt") + "' and guide_id ='" + session.getAttribute("lid") + "'";
                    ResultSet rsu = con.selectCommand(selu);
                    if (rsu.next()) {
                        String up = "update tbl_guide set guide_password='" + request.getParameter("txtnew") + "' where guide_id ='" + session.getAttribute("lid") + "'";
