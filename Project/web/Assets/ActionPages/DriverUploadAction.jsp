<%-- 
    Document   : DriverUploadAction.jsp
    Created on : 19 Feb, 2024, 5:49:28 PM
    Author     : vinum
--%>
...
//checking if request cotains multipart data
    ...
    if (isMultipart) {
        ...
        while (itr.hasNext())//checking if there is any value in the position like rs.next()
        {
            ...
            String InsQry = "INSERT INTO `tbl_driver`( `driver_name`, `driver_contact`, `driver_email`,`driver_address`,place_id, `driver_photo`,`driver_password`)"
...
<script type="text/javascript">
    ...
    setTimeout(function() {
        window.location.href = '../../Guest/NewDriver.jsp'
