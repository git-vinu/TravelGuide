                    ...
                    <table border="1" cellpadding="10" align="">
                        ...
                        <%
                            if (request.getParameter("btnpay") != null) {
                                ...
                                String SelQry = "Update tbl_hotelbooking set hotelbooking_status='1' where hotelbooking_id  ='" + request.getParameter("id") + "'";
                        ...
                        <script type="text/javascript">
                            ...
                            setTimeout(function() {
                                window.location.href = 'ViewMyHotelBooking.jsp';
