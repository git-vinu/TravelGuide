    ...
    <html lang="en">
        ...
        <body>
            ...
            <div class="chat-wrapper is-standalone">
                ...
                <%
                    String selQr = "select * from tbl_guide where guide_id='" + request.getParameter("id") + "'";
                    ...
                    <div class="nav-start">
                        <div class="recipient-block">
                            <div class="avatar-container">
                                <img class="user-avatar" style="width: 42px; height:42px " src="../../Assets/Files/<%=rs.getString("guide_photo")%>" alt="">
                            </div>
                            <div class="username">
