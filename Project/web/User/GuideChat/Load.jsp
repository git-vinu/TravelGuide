...
<%
    String selQry = "select * from tbl_guide_user_chat tsc inner join tbl_user t on (tsc.to_user_id=t.user_id) or (tsc.from_user_id=t.user_id) where t.user_id='" + session.getAttribute("uid") + "' order by chat_id";
    //System.out.println(selQry);
    ResultSet rs = con.selectCommand(selQry);
    while (rs.next()) {

        if (rs.getString("to_guide_id").equals(request.getParameter("id"))) {
...
} else if (rs.getString("from_guide_id").equals(request.getParameter("id"))) {
