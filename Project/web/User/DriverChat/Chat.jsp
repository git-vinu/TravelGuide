    ...
    <html lang="en">
        ...
        <body>
            ...
            <div class="chat-wrapper is-standalone">
                ...
                <%
                    String selQr = "select * from tbl_driver where driver_id ='" + request.getParameter("id") + "'";
                    ...
                    <div class="nav-start">
                        <div class="recipient-block">
                            <div class="avatar-container">
                                <img class="user-avatar" style="width: 42px; height:42px " src="../../Assets/Files/<%=rs.getString("driver_photo")%>" alt="">
                            </div>
                            <div class="username">
                                <span><%=rs.getString("driver_name")%></span>
                            </div>
                        </div>
                    </div>
                    <div class="nav-end">
