...
public final class ViewMyGuideBooking_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("    </head>\n");
      out.write("    <body>\n");
      out.write("        <h1>My Guide Bookings</h1>\n");
      ...
      out.write("            ");
                ...
                int i = 0;
                String selQry = "select * from tbl_guidebooking s inner join tbl_user c on s.user_id=c.user_id where guide_id='" + session.getAttribute("gid") + "'";
      ...
      out.write("</td>\n");
      out.write("                <td>");
      out.print( rs.getString("guidebooking_status"));
      out.write("</td>\n");
      out.write("\n");
      out.write("            </tr>\n");
      out.write("            ");
