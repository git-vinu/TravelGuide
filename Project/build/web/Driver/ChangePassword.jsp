...
<%-- 
    ...
    Created on : 22 Feb, 2024, 2:15:18 PM
    Author     : vinum
--%>
        ...
        <div id="tab">
            <%
                if (request.getParameter("btnedit") != null) {
                    String selu = "select * from tbl_driver where driver_password='" + request.getParameter("txtcurnt") + "' and driver_id='" + session.getAttribute("did") + "'";
                    ResultSet rsu = con.selectCommand(selu);
                    if (rsu.next()) {
                        String up = "update tbl_driver set driver_password='" + request.getParameter("txtnew") + "' where driver_id='" + session.getAttribute("did") + "'";
