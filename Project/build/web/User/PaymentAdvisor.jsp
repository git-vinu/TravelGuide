                    ...
                    <table border="1" cellpadding="10" align="">
                        ...
                        <%
                            if (request.getParameter("btnpay") != null) {
                                ...
                                String SelQry = "Update tbl_advicorbooking set advicorbooking_status='1' where advicorbooking_id ='" + request.getParameter("id") + "'";

                                con.executeCommand(SelQry);
                        %>

                        <script type="text/javascript">
                            alert("PaymentDriver Sucessful...");
                            setTimeout(function() {
                                window.location.href = 'ViewMyAdvisorBooking.jsp';
