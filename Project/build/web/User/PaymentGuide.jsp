                    ...
                    <table border="1" cellpadding="10" align="">
                        ...
                        <%
                            if (request.getParameter("btnpay") != null) {
                                ...
                                String SelQry = "Update tbl_guidebooking set guidebooking_status='1' where guidebooking_id ='" + request.getParameter("id") + "'";
                        ...
                        <script type="text/javascript">
                            ...
                            setTimeout(function() {
                                window.location.href = 'ViewMyGuideBooking.jsp';
