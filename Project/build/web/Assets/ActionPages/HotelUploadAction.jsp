<%-- 
    Document   : HotelUploadAction
    Created on : 15 Feb, 2024, 6:11:10 PM
    Author     : vinum
--%>
...
//checking if request cotains multipart data
    ...
    if (isMultipart) {
        ...
        while (itr.hasNext())//checking if there is any value in the position like rs.next()
        {
            ...
            String InsQry = "INSERT INTO `tbl_hotel`( `hotel_name`, `hotel_contact`, `hotel_email`,`hotel_address`,place_id, `hotel_password`,`hotel_photo`)"
                    + "values('" + value[0] + "','" + value[1] + "','" + value[2] + "','" + value[3] + "','" + value[5] + "','" + value[6] + "','" + photo + "')";
...
<script type="text/javascript">
    ...
    setTimeout(function() {
        window.location.href = '../../Guest/NewHotel.jsp'
