<%-- 
    Document   : AdvisorUploadAction
    Created on : 20 Feb, 2024, 9:13:42 PM
    Author     : vinum
--%>
...
//checking if request cotains multipart data
    ...
    if (isMultipart) {
        ...
        while (itr.hasNext())//checking if there is any value in the position like rs.next()
        {
            ...
            String InsQry = "INSERT INTO `tbl_advicor`( `advicor_name`, `advicor_contact`, `advicor_email`,`advicor__address`,place_id, `advicor_photo`,`advicor_password`)"
...
<script type="text/javascript">
    ...
    setTimeout(function() {
        window.location.href = '../../Guest/NewAdvisor.jsp'
