<%-- 
    Document   : GuideUploadAction.jsp
    Created on : 19 Feb, 2024, 5:03:55 PM
    Author     : vinum
--%>
...
//checking if request cotains multipart data
    ...
    if (isMultipart) {
        ...
        while (itr.hasNext())//checking if there is any value in the position like rs.next()
        {
            ...
            String InsQry = "INSERT INTO `tbl_guide`( `guide_name`, `guide_contact`, `guide_email`,`guide_address`,place_id, `guide_photo`,`guide_password`)"
...
<script type="text/javascript">
    ...
    setTimeout(function() {
        window.location.href = '../../Guest/NewGuide.jsp'
